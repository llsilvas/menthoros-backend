...
/**
 * Duplo de {@link TsbChunkRecalculador} para testes unitários: executa o bloco e a consolidação
 ...
 *
 * <p>A propagação transacional de verdade é coberta por {@code TsbChunkRecalculadorIT}, contra banco.
 ...
 */
public class TsbChunkRecalculadorInline extends TsbChunkRecalculador {

    public TsbChunkRecalculadorInline() {
        super(null);
    }
